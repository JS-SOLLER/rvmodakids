                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header text-center">
                                    <img class="img-thumbnail" src="assets/img/LOGO RV MODA.jpg" width="100">
                                    <h3 class="font-weight-light my-4">Inicie Sesión en RVModaSIS</h3>
                                </div>
                                <div class="card-body">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; <a href="" target="_blank" rel="noopener noreferrer">RV MODA KIDS 2024</a> <?php echo date("Y"); ?></div>
                        <div>
